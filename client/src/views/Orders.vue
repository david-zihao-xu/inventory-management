      ...
      <div v-if="submittedOrders.length > 0" class="card">
        <div class="card-header">
          <h3 class="card-title">
            ...
            <span class="badge info" style="margin-left: 0.75rem; vertical-align: middle;">{{ t('status.submitted') }}</span>
          </h3>
        </div>
          ...
          <table class="orders-table submitted-orders-table">
            ...
            <tbody>
              <tr v-for="order in submittedOrders" :key="order.id">
                ...
                <td class="col-lead-time">{{ t('orders.leadTimeDays', { days: order.lead_time_days != null ? order.lead_time_days : leadTimeFallback(order) }) }}</td>
...
export default {
  ...
  setup() {
    ...
    // Restock orders arrive via POST /api/orders with status "Submitted" and source "restock"
...
/* Lead-time column used in the Submitted Orders table */
.col-lead-time {
  width: 110px;
}

/* The submitted-orders table omits the customer/status columns, so relax fixed layout */
